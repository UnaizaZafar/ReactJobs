  ...
  return (
    <>
      ...
      <div className="flex p-8 gap-4 bg-indigo-100">
        ...
        <div className="bg-white flex rounded-lg flex-col p-8 gap-3 shadow-md w-full max-w-lg">
          ...
          <p className="bg-indigo-200 font-extrabold p-2">{job.company.contactEmail}</p>

          <h2 className="text-xl font-medium"> Contact Phone:</h2>
          <p className="bg-indigo-200 font-extrabold p-2">{job.company.contactPhone}</p>
        </div>
        <div className="bg-white flex flex-col rounded-lg p-8 gap-3 shadow-md w-full max-w-96">
            <h1 className="font-extrabold text-lg">Manage Job</h1>
            <Link to='' className='bg-indigo-700 text-white px-2 py-1 font-medium rounded-2xl text-center'>Edit Job</Link>
            <Link to='' className='bg-red-700 text-white px-2 py-1 font-medium rounded-2xl text-center'>Delete Job</Link>
